              ...
              <div className="col order-lg-last">
                <div className="ps-xxl-4 wow fadeInRight">
                  ...
                  <p>
                    ...
                    conduct that we believe violates these Terms of Use or is
                    otherwise harmful to other users of the Service, us, or
                  ...
                  <p className="mt-20 md-mt-20 mb-40 md-mb-20">
                    ...
                    our website. Your continued use of the Service after any
