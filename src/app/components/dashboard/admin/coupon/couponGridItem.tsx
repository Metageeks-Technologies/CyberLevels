    ...
    >
      ...
      <div className="d-flex action-dots justify-content-end d-flex float-end ">
        ...
        <div className="d-flex align-items-center justify-content-center mt-auto">
          <div className="job-location d-flex justify-content-center" style={{fontSize:'x-large',color:'red',fontWeight:'600'}}>
        ...
        <div
          ...
          className="apply-btn text-center tran3s mt-3" style={{width:'100%'}}
          // onClick={() => handleViewClick(item._id)}
        >
          {readableStrings}
        </div>
